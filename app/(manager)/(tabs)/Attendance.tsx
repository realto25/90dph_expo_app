...
const API_URL =
  process.env.EXPO_PUBLIC_API_URL || "https://90-dph.vercel.app";
...
export default function MarkAttendanceScreen() {
  ...
  return (
    // Removed SafeAreaView from wrapping the entire component,
    // and instead applied padding to the LinearGradient and ScrollView
    // to handle safe areas directly.
      ...
      >
        ...
        <Card>
          ...
          {location ? (
            ...
            <View style={{ backgroundColor: '#FCE7E7', padding: 16, borderRadius: 12 }}>
