        ...
        <View style={styles.contentCard}>
          <View style={styles.contentPadding}>
            ...
            {plot.lands?.find((land) => land.status === 'AVAILABLE' && land.imageUrl) && (
              <View style={styles.landImageContainer}>
                <Text style={styles.sectionTitle}>Available Land</Text>
                <Image
                  source={{
                      ...
                      <View style={styles.landHeader}>
                        ...
                        <View
                          style={[
                            styles.landStatus,
                            {
                              backgroundColor: land.status === 'AVAILABLE' ? '#22C55E' : '#EF4444',
                            },
                          ]}>
                          <Text style={styles.landStatusText}>{land.status}</Text>
                        </View>
                      </View>
      ...
      {plot.status.toLowerCase() === 'available' && (
        <View style={styles.bottomButton}>
          <TouchableOpacity
            ...
            onPress={() => router.push(`/buy-request/${plot.id}`)}>
